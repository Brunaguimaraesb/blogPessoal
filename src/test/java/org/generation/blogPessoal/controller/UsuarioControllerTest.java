...
public class UsuarioControllerTest {
	...
	public void start() {
		...
		usuarioAdmin = new Usuario(0L, "Administrador", "admin@email.com.br", "admin123","foto",  dataAdmin, "admin");
		...
		usuario = new Usuario(0L, "Paulo Antunes", "paulo@email.com.br", "13465278", "foto", dataPost,"admin");
		
		LocalDate dataPut = LocalDate.parse("2000-07-22", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
		usuarioUpdate = new Usuario(2L, "Paulo Antunes de Souza", "paulo_souza@email.com.br", "souza123","foto", dataPut, "admin");
	}
